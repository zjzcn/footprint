...
import com.footprint.server.common.utils.DigestUtils;
...
public class ShiroDbRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		Set<String> perms = userManager.getCurrentPermSet();
		if (perms == null) {
			return null;
		}
		...
		logger.info("User[{}] has permission set:{}", userManager.getCurrentUsername(),
